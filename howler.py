...
parser.add_argument('playlistFile', type=file, help='If mode=list: A file containing playlist urls to download\n If mode=source, a file containing the source code of a playlist to parse')
